...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUser.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 12)); // NOI18N
        ...
        txtPassword.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 12)); // NOI18N
        ...
        jLabel5.setText("User : JerryFitriansyah");

        jLabel6.setFont(new java.awt.Font("Microsoft YaHei UI", 1, 12)); // NOI18N
        jLabel6.setText("Pass : 2109106067");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            Connection dbconn = Configuration.getConnection();
            PreparedStatement st = (PreparedStatement)
            dbconn.prepareStatement("SELECT * FROM tbakun WHERE username = ? AND password = ?");
            st.setString(1, username);
            st.setString(2, password);
            ResultSet res = st.executeQuery();
            if(res.next()){
                    JOptionPane.showMessageDialog(this, "Asik bisa login", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                    CRUD crud = new CRUD();
                ...
                txtUser.setText("");
                txtPassword.setText("");
                JOptionPane.showMessageDialog(this,"Waduh salah bro", "Peringatan", JOptionPane.WARNING_MESSAGE);
            }
            
        } catch (SQLException ex) {
            System.out.println("Gagal bro loginnya !");
        }
